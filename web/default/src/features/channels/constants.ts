...
const CHANNEL_TYPE_DISPLAY_ORDER: number[] = [
  1, 14, 200, 33, 24, 43, 3, 41, 48, 58, 42, 34, 20, 4, 40, 27, 25, 17, 26, 15, 46,
...
export const MODEL_FETCHABLE_TYPES = new Set([
  1, 4, 14, 17, 20, 23, 24, 25, 26, 27, 31, 34, 35, 40, 42, 43, 47, 48, 200,
])
...
export const TYPE_TO_KEY_PROMPT: Record<number, string> = {
  ...
  200: 'Paste Claude Code OAuth JSON credential (access_token / refresh_token), or use the "Authorize" button',
}
