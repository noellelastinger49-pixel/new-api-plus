...
var channelPermissionRoutes = []permissionRoute{
	...
	{method: http.MethodPost, path: "/claude-code/oauth/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartClaudeCodeOAuth},
	{method: http.MethodPost, path: "/claude-code/oauth/complete", permission: authz.ChannelSensitiveWrite, handler: controller.CompleteClaudeCodeOAuth},
	{method: http.MethodPost, path: "/:id/claude-code/oauth/start", permission: authz.ChannelSensitiveWrite, handler: controller.StartClaudeCodeOAuthForChannel},
	{method: http.MethodPost, path: "/:id/claude-code/oauth/complete", permission: authz.ChannelSensitiveWrite, handler: controller.CompleteClaudeCodeOAuthForChannel},
	{method: http.MethodPost, path: "/:id/claude-code/refresh", permission: authz.ChannelSensitiveWrite, handler: controller.RefreshClaudeCodeChannelCredential},
